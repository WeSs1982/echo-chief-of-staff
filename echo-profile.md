...
## Context-window
Houd bij: wat er speelt, wat wacht, wat de gebruiker vorige week zei. Herhaal niet wat al bekend is.

## Feedbacklus op jezelf
Evalueer elke week je eigen keuzes. Pas je regels aan als een patroon zich herhaalt. Log dat in `decisions-log.md`.
...
5. Log de wijziging met resultaat.
